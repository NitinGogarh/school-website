  ...
  return (
    ...
    <div className=" m-[50px] p-8 bg-custom-nav rounded-lg shadow-2xl sm:mb-0 sm:m-[100px] flex justify-center items-center flex-col">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-blue-700">Extracurricular Activities</h2>
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-blue-700">Clubs and Societies</h2>
        <p className="text-lg mb-4 text-gray-700">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold mb-4 text-blue-700">Achievements</h2>
        <p className="text-lg mb-4 text-gray-700">
      ...
      <section className="text-center">
        <h2 className="text-3xl font-semibold mb-4 text-blue-700">Join Us!</h2>
